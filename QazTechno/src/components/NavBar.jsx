...
function NavBar({ location, getLocation }) {
  ...
  const toggleOpenMobile = () => setOpenMobile(!openMobile);
      ...
      <div className="w-full flex justify-between items-center">
        <div className="mt-3 flex gap-2 items-center">
          ...
          <div className="cursor-pointer flex items-center gap-1">
            ...
            <span className="font-semibold text-white">
              {location ? location.state : t("navbar.add_address")}
            </span>
          </div>
        </div>
       ...
       <ul className="hidden md:flex gap-3 mt-4">
        ...
        <button
          ...
          className="block md:hidden bg-primary p-2 text-white rounded-md m-4"
        >
      ...
      <div className="w-full relative mt-6 flex justify-between items-center flex-wrap gap-4">
          ...
          {openTypes && (
            <div className="absolute top-full left-0 mt-2 w-full bg-white rounded-md shadow-lg p-4 border z-50">
              <div className="flex justify-between items-center mb-3">
                <h3 className="font-semibold">{t("navbar.categories")}</h3>
                <ChevronUp
              ...
              <input
                ...
                placeholder={t("navbar.search_categories")}
                value={searchQuery}
        ...
        <div className="flex gap-4">
          <div className="mt-3">
            <SignedOut>
              <SignInButton>
                <button className="btn-secondary">{t("navbar.sign_in")}</button>
              </SignInButton>
            </SignedOut>
