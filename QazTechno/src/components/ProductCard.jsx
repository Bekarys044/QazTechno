...
function PriductCard({product}) {
  ...
  return (
    <div className=" bg-white  relative rounded-2xl cursor-pointer  hover:scale-105 hover:shadow-md
     transition-all duration-300 ease-in-out">
      ...
      <div className="absolute z-10 top-2 left-1 flex gap-2 p-1 bg-red-500 rounded-md">
       ...
       <div className="flex gap-2 items-center  mb-2">
         <p className="my-1 text-[1.5rem] font-bold text-red-500 hover:text-red-400">$ {product.price}</p>
        ...
        <button
          ...
          className="bg-primary hover:bg-[#2066e8] px-2 py-1 text-lg rounded-md text-white
        w-full flex gap-12 items-center justify-center"
        >
